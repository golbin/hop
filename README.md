...
설치 없이 브라우저에서 HOP를 바로 체험할 수 있습니다. 문서 파싱과 렌더링이 전부 브라우저 안(WASM)에서 동작하므로, 문서가 서버로 전송되지 않습니다.

* [웹 데모 열기](https://golbin.github.io/hop/demo/)

웹 데모는 열기/편집/저장(브라우저 다운로드)을 지원합니다. PDF 내보내기, 파일 연결 같은 OS 통합 기능은 데스크톱 앱에서 사용할 수 있습니다.
